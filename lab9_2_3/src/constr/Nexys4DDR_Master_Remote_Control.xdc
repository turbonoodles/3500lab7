...
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { up }]; # Sch = SW1
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { pulse_1s }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
